"""
Final script to create the convolved hemodynamic response function.


Does the correct method to convolve the condition files for the output as well
as the time shifting that is required.

The result is stored in matrices for the specific condition file and the shifts
per time.
