...
## CONS
# 1. Different length compared to data.shape[-1] (time dimension) 
#    - could be changed to get these (but currently not designed)
...
# Problem for my convolution (different length than data.shape[-1] and np.convolve vector)
...
plt.savefig('../Images/convolution_vs_neural-stimulus.png')
plt.close()
print("********")
